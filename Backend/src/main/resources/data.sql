...
('Alex Suarez', 'contraseña1', 'usuario1@example.com', '¡Hola! Soy Alex Suarez, un apasionado Diseñador con un amor profundo por la creatividad y la tecnología. Me considero un eterno soñador que se dedica a convertir ideas innovadoras en experiencias digitales asombrosas. Mi enfoque se basa en fusionar diseño y funcionalidad para crear soluciones impactantes y atractivas.', 'https://res.cloudinary.com/dnc3btlfa/image/upload/f_auto,q_auto/v1/TheSphere/gngxflevkl5ebbg6zuwi', 'https://res.cloudinary.com/dnc3btlfa/image/upload/f_auto,q_auto/v1/TheSphere/g62qz8zhk92xpfzo3lfo', 'España'),
('Marco Rossi', 'contraseña2', 'usuario2@example.com', 'Biografía del usuario 2.', 'https://res.cloudinary.com/dnc3btlfa/image/upload/f_auto,q_auto/v1/TheSphere/bja07qnyqrs8y9ncm9ab', 'ruta/a/imagen4.jpg', 'México'),
('Javier Galiñanes', 'contraseña3', 'usuario3@example.com', 'Biografía del usuario 3.', 'https://res.cloudinary.com/dnc3btlfa/image/upload/f_auto,q_auto/v1/TheSphere/z6zphpnjenh082sheope', 'ruta/a/imagen6.jpg', 'Argentina'),
('Teo Gallego', 'contraseña4', 'usuario4@example.com', 'Hola chavales soy Teo.', 'https://res.cloudinary.com/dnc3btlfa/image/upload/f_auto,q_auto/v1/TheSphere/dnzixmubpdbqajqvaru3', 'https://res.cloudinary.com/dnc3btlfa/image/upload/f_auto,q_auto/v1/TheSphere/pvlxmdmflh2baexy04i9', 'Francia'),
('Lola Bermudez', 'contraseña5', 'usuario5@example.com', 'Biografía del usuario 5.', 'https://res.cloudinary.com/dnc3btlfa/image/upload/f_auto,q_auto/v1/TheSphere/sxasf9hklnlmrddns1vb', 'ruta/a/imagen10.jpg', 'Chile');
